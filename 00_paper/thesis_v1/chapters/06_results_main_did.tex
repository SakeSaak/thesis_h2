...
The honest-DiD bounds of Section \ref{sec:results_did_honest} relax the parallel-trends assumption parametrically. A complementary robustness strategy is to abandon the parallel-trends assumption entirely in favour of a synthetic-control identification design. The Synthetic Difference-in-Differences (SDID) estimator of \cite{arkhangelsky2021synthetic} combines synthetic-control unit weights with DiD time-weights, achieving identification under a weaker doubly-weighted balancing condition.
