...
On 3 January 2025, the US Treasury Department and IRS issued the Final Regulations on the Section 45V Clean Hydrogen Production Tax Credit \cite{treasury2025final45v}, published in the Federal Register on 10 January 2025. The Final Rules retained the core three-pillars architecture analysed in Section \ref{sec:results_did_45v} (additionality, hourly time matching, and geographic deliverability) but with multiple loosening modifications relative to the December 2023 Proposed Rules: expanded use of energy attribute certificates, clarifications on natural-gas-alternative pathways including renewable natural gas and coal-mine methane, and a delayed phase-in of hourly matching until 2030. The Final Rules thereby represent a partial walking-back of the most stringent NPRM provisions that drove the $+0.285$ DDD point estimate documented in Chapter \ref{ch:results_did}.
