...
The hydrogen industry is currently undergoing what one analyst termed a transition ``from speculative tail to bankable core'' \cite{decarbonizeweekly2026}. The substantive contribution of this thesis is to provide the first rigorous econometric characterisation of which policy mechanisms can accelerate this transition --- and which cannot.
