...
[![Status: v1.2 release](https://img.shields.io/badge/status-v1.2%20release-green.svg)](#status)
...
the most recent version). The version-specific DOI for the current release (v1.2) is
`10.5281/zenodo.20369834` and can be used when citing a specific version.
