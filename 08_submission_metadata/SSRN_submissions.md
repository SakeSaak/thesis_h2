...
1. Go to https://hq.ssrn.com/submission/ssrn-submission
2. For each paper below, click "Start a new submission"
3. Copy each field from the corresponding block into the SSRN form
4. Upload the PDF from the path noted in the block
5. Set the "Date Written" field to **23 May 2026**
6. Under "Networks/Topics", select the recommended networks listed in the block
7. Acknowledgements field: leave blank (single-author work, no formal supervisor relationship)
8. Submit — SSRN normally accepts submissions within 24-48 hours
...
Sake Saakstra (sole author, independent researcher, Amsterdam)
...
time-varying parameter, score-driven model, state-space, survival modelling, Diebold-Mariano test, hydrogen, sparse events, structural break

### Recommended SSRN Networks/Topics

Econometrics: Mathematical Methods & Programming (EJOUR-ECONOMETRICS); Econometrics: Single Equation Models; Time-Series Cross-Sectional & Panel Data Methods; Energy Economics
...
```bibtex
@unpublished{saakstra2026paper1,
  author = {Saakstra, Sake},
  title  = {A time-varying-parameter state-space approach to sparse-event survival modelling: methodological design, out-of-sample performance, and application to hydrogen project implementation-risk},
  year   = {2026},
  month  = {may},
  note   = {Working paper. Companion to thesis archived at \url{https://doi.org/10.5281/zenodo.20359771}},
...
difference-in-differences, honest sensitivity, clean hydrogen, carbon pricing, policy evaluation, mechanism design, carbon border adjustment

### Recommended SSRN Networks/Topics

Environmental Economics; Energy Economics; Public Economics: Taxation, Subsidies, & Revenue; Microeconomics: Production, Pricing, & Market Structure
...
```bibtex
@unpublished{saakstra2026paper2,
  author = {Saakstra, Sake},
  title  = {Mechanism Design over Magnitude: A Multi-Jurisdiction Evaluation of Carrot-Policy Effectiveness in Clean-Hydrogen Implementation},
  year   = {2026},
  month  = {may},
  note   = {Working paper. Companion to thesis archived at \url{https://doi.org/10.5281/zenodo.20359771}},
  url    = {https://github.com/SakeSaak/thesis_h2}
...
offtake commitment, counterparty risk, revenue volatility, real options, sectoral heterogeneity, matching estimators, Oster sensitivity, clean hydrogen

### Recommended SSRN Networks/Topics

Environmental Economics; Energy Economics; Microeconomics: Decision-Making under Risk & Uncertainty; Corporate Finance: Capital Investment
...
```bibtex
@unpublished{saakstra2026paper3,
  author = {Saakstra, Sake},
  title  = {The Offtake-Commitment Mechanism: Sigma-Channel Identification via Cross-Sectoral Heterogeneity in Clean-Hydrogen Investment},
  year   = {2026},
  month  = {may},
  note   = {Working paper. Companion to thesis archived at \url{https://doi.org/10.5281/zenodo.20359771}},
  url    = {https://github.com/SakeSaak/thesis_h2}
...
real options, irreversible investment, policy uncertainty, transition risk, mechanism design, clean technology, pre-registered falsifiability, comparative statics

### Recommended SSRN Networks/Topics

Microeconomics: Decision-Making under Risk & Uncertainty; Corporate Finance: Capital Investment; Real Options; Energy Economics; Environmental Economics
...
```bibtex
@unpublished{saakstra2026paper4,
  author = {Saakstra, Sake},
  title  = {Dynamic Investment under Transition Uncertainty: A Five-Channel Policy Framework for Clean Technology},
  year   = {2026},
  month  = {may},
  note   = {Working paper. Companion to thesis archived at \url{https://doi.org/10.5281/zenodo.20359771}},
  url    = {https://github.com/SakeSaak/thesis_h2}
